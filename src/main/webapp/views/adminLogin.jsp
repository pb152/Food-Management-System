  ...
  <div class="container py-5 h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
		...
		<form action="adminsuccesslogin">
				<div class="form-outline form-white mb-4">
                <input type="number" name="admin_id" id="typeEmailX" class="form-control form-control-lg" placeholder=" Enter ID" required/>
                </div>
              ...
              <p class="small mb-5 pb-lg-2"><a class="text-white-50" href="forgotpasswordadmin">Forgot password?</a></p>
