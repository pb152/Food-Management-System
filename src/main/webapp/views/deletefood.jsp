...
<h1 style="margin:20px 0 30px 0;color:white" ><center>Welcome to <span style="color: gold;" border="2px">Foodie-BAY </span> </center></h1><hr>
	<center><h2 style="color:white">Delete Product</h2></center><hr style="width:700px;margin-left:400px">
		
	<form action="successfoodDelete">
	<div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input style="width:600px;margin-left:450px" value="${food_name}" name="food_name" type="text" disabled class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
  </div><br>
  
  <div class="mb-3">
   <h4 style="margin-left:440px"><label for="exampleInputPassword1" class="form-label" style="color:gold">Food Price</label></h4> 
    <input name="food_price" type="number" value= "${food_price}" style="width:600px;margin-left:450px" disabled class="form-control" id="exampleInputPassword1" required>
  </div><br>
  
  <div class="mb-3">
   <h4 style="margin-left:440px"><label for="exampleInputPassword1" class="form-label" style="color:white">Food Category</label></h4> 
    <input name="food_category" type="text" value= "${food_category}" style="width:600px;margin-left:450px" disabled class="form-control" id="exampleInputPassword1" required>
  </div><br>
  
  <div class="mb-3">
    <h4 style="margin-left:440px"><label for="exampleInputPassword1" class="form-label" style="color:gold">	Food Description</label></h4>
    <input name="food_desc" type="text" value= "${food_desc}"  style="width:600px;margin-left:450px" disabled class="form-control" id="exampleInputPassword1" required>    
  </div>
  
  <hr style="width:700px;margin-left:400px;margin-bottom:10px">
 <center> <button style="margin-bottom:30px;background-color:gold;color:black" type="submit" class="btn btn-primary">Delete Food</button></center>
</form>
