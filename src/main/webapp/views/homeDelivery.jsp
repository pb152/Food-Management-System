...
<body style='background-color: #FFDDCA;'>
	...
	<hr>
	<center>
		<h2 style="color: white">Home Delivery details</h2>
	</center>
	<br>
	<hr style="width: 500px; margin-left: 500px">

	<h2 class="fw-bold mb-2 text-uppercase" style="color:gold;margin-left:20px">Your order will be
		delivered at your doorstep <br> within 30 minutes.</h2><br>
	<h3 class="text-50 mb-5" style="margin-left:20px;color:white">Thanks for ordering with us !</h3>
	<br>
