...
<h1 style="margin:20px 0 30px 0;color:white" ><center>Welcome to <span style="color: gold;" border="2px">Foodie-BAY </span> </center></h1><hr>
	<center><h2 style="color:white">Update Coupon</h2></center><hr style="width:700px;margin-left:400px">
	
		
	<form action="successcouponUpdate">
	<div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input style="width:600px;margin-left:450px" value="${coupon_name}" name="coupon_name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
  </div><br>
  
  <div class="mb-3">
   <h4 style="margin-left:440px"><label for="exampleInputPassword1" class="form-label" style="color:gold">Coupon Discount</label></h4> 
    <input name="coupon_discount" type="number" step="any" value= "${coupon_discount}" style="width:600px;margin-left:450px" class="form-control" id="exampleInputPassword1" required>
  </div><br>
  
 
  <hr style="width:700px;margin-left:400px">
 <center> <button type="submit" class="btn btn-primary" style="background-color:gold;color:black">Update Coupon</button></center>
</form>
