...
<h1 style="margin:20px 0 30px 0;color:white"><center>Welcome to <span style="color: gold;" border="2px">Foodie-BAY </span> </center></h1><hr>
	<center><h2 style="color:white">Search coupon to update</h2></center><hr style="width:700px;margin-left:400px">
	<br>
		
	<form action="searchcouponUpdate">
  <div class="mb-3">
    <h4 style="margin-left:440px"><label for="exampleInputEmail1" class="form-label" style="color:gold">Coupon Id</label></h4>
    <input style="width:600px;margin-left:450px"  name="coupon_id" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
  </div><br>
